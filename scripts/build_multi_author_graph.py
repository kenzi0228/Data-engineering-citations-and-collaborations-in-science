...
from citation_graphs.multi_author import build_multi_author_graph_from_input, build_multi_author_slug


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build a multi-author collaboration graph from parquet-based data.")
...
def main() -> None:
    ...
    graph_name = args.graph_name or f"{build_multi_author_slug(args.authors, args.match_mode)}_collaboration"
    ...
    print("Multi-author graph build completed.")
    print(result)
